...
def get_args():
    ...
    parser.add_argument("--input", type=str, default="data/ngan.jpg", help="Path to input image")
    parser.add_argument("--output", type=str, default="out_put/ngan_txt.txt", help="Path to output text file")
